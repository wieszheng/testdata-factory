          ...
          <div className="glass-card p-3 sm:p-4 mb-3">
            ...
            <div className="mb-3">
              <div className={`rounded-lg border overflow-hidden transition-all ${
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className={`p-1 rounded ${isDark ? 'bg-blue-500/20' : 'bg-blue-50'}`}>
                      <Code className={`w-3.5 h-3.5 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
                    </div>
                    <span className={`text-xs font-medium ${isDark ? 'text-slate-200' : 'text-gray-900'}`}>
                      Regex Rule Generator
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${showRegex ? 'rotate-180' : ''} ${isDark ? 'text-slate-400' : 'text-gray-400'}`} />
                  </div>
                </button>
                
                {/* 展开内容 */}
                {showRegex && (
                  <div className={`p-3 pt-0 border-t ${isDark ? 'border-slate-700' : 'border-gray-200'}`}>
                    <div className={`rounded-lg border p-3 mt-3 ${
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                          <label className={`text-[10px] font-medium ${isDark ? 'text-slate-400' : 'text-gray-600'}`}>
                            Field Name
                          </label>
                          <input 
                            type="text" 
                            ...
                            className={`h-8 text-[10px] rounded-md border px-2.5 w-full transition-colors ${
                              isDark 
                                ? 'bg-slate-900 border-slate-600 text-white placeholder:text-slate-500 focus:border-blue-500 focus:outline-none' 
                                : 'bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none'
                            }`} 
                          />
                        </div>
                        <div className="space-y-1.5">
                      ...
                      <div className="space-y-1.5 mt-3">
                        ...
                        <input 
                          ...
                          placeholder="e.g. ORD\d{14}"
                          className={`h-8 text-[10px] font-mono rounded-md border px-2.5 w-full transition-colors ${
                            isDark 
                              ? 'bg-slate-900 border-slate-600 text-emerald-400 placeholder:text-slate-500 focus:border-emerald-500 focus:outline-none' 
                              : 'bg-white border-gray-300 text-emerald-600 placeholder:text-gray-400 focus:border-emerald-500 focus:outline-none'
                          }`} 
                        />
                      </div>
                      ...
                      <button 
                        ...
                        className={`w-full h-8 mt-3 text-[10px] font-medium rounded-md transition-all flex items-center justify-center gap-1.5 ${
                          isDark 
